...
describe 'Manager' do
  describe '#initialize' do
    ...
    it 'has collections of rooms' do
      ...
      @manager.all_rooms[0].must_equal 1
      @manager.all_rooms[19].must_equal 20
    end
  ...
  describe '#add_reservation' do
    ...
    it 'Selects a room' do
      @new_reservation.room.must_be_kind_of Integer
    end
  ...
  describe '#total_cost_of_reservation' do
    before do
      ...
      @manager.add_reservation('22 Apr 2018','23 Apr 2018') #reservatio id =  3
    end
  ...
  describe '#available_rooms' do
    it 'returns a list of available rooms' do
      ...
      @manager.available_rooms('3rd Feb 2020', '5 Feb 2020' )[0].must_be_kind_of Integer
  ...
  describe '#reserve_room' do
    ...
    it 'reserves a specific room' do
      @new_reservation.room.must_equal 20
      @new_reservation.room.must_be_kind_of Integer
    end
  ...
  describe '#check_available_block_rooms' do
    ...
    it 'returns available rooms in the block' do
      ...
      @manager.check_available_block_rooms(1)[0].must_be_kind_of Integer
    end
  ...
  describe '#reserve_room_in_block' do
    ...
    it 'reservers a room from a specific block' do
      ...
      @manager.all_reservations[0].room.must_equal 2
    ...
    it 'sets room as unvailable for other types of reservations for that date' do
      room_id = @new_block_room_reservation.room
      # Assert:
